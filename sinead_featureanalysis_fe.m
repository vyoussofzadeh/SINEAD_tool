function fig = sinead_featureanalysis_fe()
...
% ___________________________________________________________________________
disp('sinead_feature extraction ...')
col = [0.9020 0.9072 0.9014];
h0 = figure('Color',[1 1 1], ...
	'PaperPosition',[18 180 576 432], ...
	'PaperUnits','points', ...
	'Position',[460 560 390 210], ...
	'Tag','Main', ...
	'NumberTitle','off',...
    'MenuBar','none', ...
...
h1 = uicontrol('Parent',h0, ...
	...
	'String','Intracranial brain volumes (MRI)', ...
	'CallBack','sinead_featureanalysis_fe_IntBV;');
h2 = uicontrol('Parent',h0, ...
	'Units','points', ...
	'BackgroundColor',col, ...
	'Position',[72 60 166 16], ...
	'String','Average intensity (PET)', ...
	'CallBack','sinead_featureanalysis_fe_AveInt;');
